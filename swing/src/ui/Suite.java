...
public class Suite extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("BẰNG LÁI XE THÔNG MINH - SMART DRIVING LICENSE SUITE");
        jPanel7.add(jLabel1);
    ...
    private void connectBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_connectBtnActionPerformed
        ...
        if (APDU.getInstanse().connectCard(EncodeUtils.hexStringToByteArray(Applet.APPLET_AID))) {
            ...
            License license = LicenseService.getInstanse().getLicenseInfo(APDU.getInstanse().makeCommand(00, Instruction.INS_READ_BASIC_INFO, 00, 00));
    ...
    private void checkFaultBtnMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_checkFaultBtnMousePressed
        // TODO add your handling code here:
        try {
            List<Fault> faultList = LicenseService.getInstanse().getFaultList(APDU.getInstanse().makeCommand(00, Instruction.INS_READ_FAULT_INFO, 00, 00));
            renderFaultList(faultList);
    ...
    private void writeFaultActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_writeFaultActionPerformed
        ...
        try {
            ...
            int faultCode = mapIndexToFaultCode(faultIndex);
            ...
            ResponseAPDU response = APDU.getInstanse().makeCommand(00, Instruction.INS_WRITE_NEW_FAULT, 00, 00, cdata);
    ...
    private void btnChangeCardIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChangeCardIdActionPerformed
        ...
        ResponseAPDU response = APDU.getInstanse().makeCommand(00, Instruction.INS_REWRITE_CARD_ID, 00, 00, cdata);
        if (response.getSW1() == 0x90) {
    ...
    private void btnChangeFullNameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChangeFullNameActionPerformed
        ...
        ResponseAPDU response = APDU.getInstanse().makeCommand(00, Instruction.INS_REWRITE_FULLNAME, 00, 00, text.getBytes());
        if (response.getSW1() == 0x90) {
            JOptionPane.showMessageDialog(null, "Ghi thành công ");
        } else {
            JOptionPane.showMessageDialog(null, "Ghi không thành công");
    ...
    private void btnChangeBirthDateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChangeBirthDateActionPerformed
        ...
        ResponseAPDU response = APDU.getInstanse().makeCommand(00, Instruction.INS_REWRITE_BIRTH_DATE, 00, 00, cdata);
        if (response.getSW1() == 0x90) {
            JOptionPane.showMessageDialog(null, "Ghi thành công ");
        } else {
            JOptionPane.showMessageDialog(null, "Ghi không thành công");
    ...
    private void btnChangeAddressActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChangeAddressActionPerformed
        ...
        ResponseAPDU response = APDU.getInstanse().makeCommand(00, Instruction.INS_REWRITE_HOMETOWN, 00, 00, text.getBytes());
        if (response.getSW1() == 0x90) {
            JOptionPane.showMessageDialog(null, "Ghi thành công ");
        } else {
            JOptionPane.showMessageDialog(null, "Ghi không thành công");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            ResponseAPDU response = APDU.getInstanse().makeCommand(00, Instruction.INS_REWRITE_AVATAR_IMAGE, 00, 00, bArray);
            if (response.getSW1() == 0x90) {
                JOptionPane.showMessageDialog(null, "Ghi thành công ");
            } else {
                JOptionPane.showMessageDialog(null, "Ghi không thành công");
    ...
    private void btnChangeExpireDateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChangeExpireDateActionPerformed
        ...
        byte[] cdata = new byte[]{(byte) date, (byte) month, (byte) yearX, (byte) yearY};
        System.out.println(Arrays.toString(text.getBytes()));
        ResponseAPDU response = APDU.getInstanse().makeCommand(00, Instruction.INS_REWRITE_EXPIRE_DATE, 00, 00, cdata);
        if (response.getSW1() == 0x90) {
            JOptionPane.showMessageDialog(null, "Ghi thành công ");
        } else {
            JOptionPane.showMessageDialog(null, "Ghi không thành công");
    ...
    private void renderLicenseInfo(License license) {
    ...
    private int mapIndexToFaultCode(int faultIndex) {
        switch (faultIndex) {
            case 0:
                return Fault.OVER_SPEED_FAULT;
            case 1:
                return Fault.VIOLATE_ALCOHOL_FAULT;
            case 2:
                return Fault.OVER_WEIGHT_FAULT;
            case 3:
                return Fault.LIGHT_SIGNAL_FAULT;
            case 4:
                return Fault.MISSING_EQUIPMENT_FAULT;
            case 5:
                return Fault.WRONG_LANE_FAULT;
            default:
                return 0;
        }
    }

    private void renderFaultList(List<Fault> faultList) {
